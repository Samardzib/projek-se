...
<section class="pc-container">
    <div class=" div-flex1">
        ...
        <div class="header-container">
            <h4 class="mt-7">Calendar</h4>
            <button class="see-all" onclick="window.location.href='/calender'">See all</button>
        </div>
    ...
    <div class=" div-flex2">
        <div class="header-container">
            <h4 class="mt-7">Notification</h4>
            <button class="see-all" onclick="window.location.href='/notification'">See all</button>
        </div>
        <div class="notification-section"></div>

        <div class="header-container">
            <h4 class="mt-7">To Do List</h4>
        </div>
