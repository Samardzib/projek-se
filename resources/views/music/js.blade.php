        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response.data, function(key, value) {
                    ...
                    $('.music-grid').append(`
                        <div class="music-item" onclick="playMusic('music-list/${value.music_url}', '${value.music_name}', '${value.music_cover}', ${key})">
                            <img src="{{ asset('album-list/${value.music_cover}') }}" alt="${value.music_name}">
                            <div class="music-item-title">${value.music_name}</div>
                        </div>
                    `);
                });
            },
